...
Then use if-elif-else statements to perform the requested math operation on the
numbers and display the result.

If the user enters an unknown operation, display an error message
(use `messagebox.showerror()`).
